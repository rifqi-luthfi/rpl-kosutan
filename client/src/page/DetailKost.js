...
const DetailKost = () => {
    return (
        <>
            <Header />
            <div className="container flex flex-wrap md:flex-nowrap mx-auto my-12 px-12 lg:px-0 md:px-6 lg:my-32">
                <img className="flex-auto mr-12 w-full md:w-1/6 rounded-md mb-6"alt="logo" src={process.env.PUBLIC_URL + '/detail_1.png'} />
                <div className="flex-auto mb-6 mr-12">
                ...
                <div className="h-52 flex-1 w-auto border-2 rounded-xl px-6 py-12 flex flex-col justify-center bg-white">
